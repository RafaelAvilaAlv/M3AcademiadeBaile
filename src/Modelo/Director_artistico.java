 ...
 * @author Usuario
 */
public class Director_artistico extends Empleado {
    ...
    public Director_artistico(int pro_codemp, int pro_codigo, int pro_expe, String pro_estado) {
    ...
    public Director_artistico(int pro_codemp, int pro_codigo, int pro_expe, String pro_estado, int emp_codigo, int emp_codper, Date emp_fechacontratacion, Double emp_salario) {
